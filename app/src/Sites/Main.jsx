   ...
   return (
       <>
          <div id="wholePage" className=" h-full w-full z-30">
            <div id='mediaForPotrait'>Please flip your phone</div>
          <div id='allItems1'>
                  ...
                  <div className=' h-full w-1/3 flex select-none'>
                     <div className=' h-full w-1/2 flex flex-col gap-2 p-8'>
                        ...
                        <ul id='elemetsPage'>
                           ...
                           <li className=' cursor-pointer' onClick={handlePortfolio}>- Projects</li>
                           <li className=' cursor-pointer' onClick={handleProjects}>- Portfolio</li>
                        </ul>
                     </div>
