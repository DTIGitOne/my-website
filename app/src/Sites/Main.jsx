...
const Main = () => {
   ...
   setTimeout(() => {
      ...
      pageElements.className = "h-full w-full flex flex-col z-30 justify-center items-center";
   ...
   return (
      <>
       <div id="wholePage" className=" h-full w-full z-30">
        <div id="loadInPage" className=" h-full w-full flex justify-center items-center z-30 absolute" >
         ...
         <div id="pageElements" className=" hidden h-full w-full ">
            <div id="logoTop"></div>
            <div id="welcomePage" className=" font-thin text-white text-8xl z-30">Welcome to my website</div>
         </div>
       </div>
      </>
);
